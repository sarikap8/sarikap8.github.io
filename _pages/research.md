...
*Submitted to EMNLP 2026* &nbsp;|&nbsp; [OpenReview](https://openreview.net/forum?id=Ppnu4Afi1N)
...
*Submitted to EMNLP 2026* &nbsp;|&nbsp; [OpenReview](https://openreview.net/forum?id=Csf4irKinu)
...
**Berkeley Speech Group** — [Prof. Gopala Anumanchipalli](https://people.eecs.berkeley.edu/~gopala/), UC Berkeley EECS
Speech and language technologies for neurocognitive disorder detection.

**Computational Precision Health** — [Prof. Irene Chen](https://irenechen.net/) & [Prof. Yulin Hswen](https://profiles.ucsf.edu/yulin.hswen), UC Berkeley & UCSF
Large-scale EHR analysis, sex differences in multimorbidity, and reproductive health equity.
